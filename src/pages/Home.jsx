...
export default function Home() {
  ...
  useEffect(() => {
    ...
    if (!video) return;
    if (video.readyState >= 3) { handleVideoReady(); return; }
            ...
            <div className="mx-auto w-full max-w-6xl flex flex-col items-center gap-8 lg:flex-row lg:items-center lg:gap-0">
              ...
              >
                <img
                  ...
                  style={{
                    ...
                    animation: isLoaded && !isSplit ? "sloganIn 0.6s ease forwards" : "none",
                    transition: "none",
                  }}
                />
              </div>
              ...
              >
                <div
                  ...
                  style={{
                    transform: carouselHovered ? "translateY(0)" : "translateY(14px)",
                ...
                <div
                  ...
                  style={{
                    ...
                    transform: carouselHovered ? "translateY(0)" : "translateY(4px)",
