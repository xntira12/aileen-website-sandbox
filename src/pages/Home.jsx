        ...
        <div className="relative z-10 flex min-h-screen items-center">
          ...
          <div className="mx-auto w-full max-w-6xl px-6 pt-24 pb-16 text-center">
            ...
            <div className="mt-10 flex flex-wrap justify-center gap-4">
              <a
                href="#about"
                className="btn-fancy group relative inline-flex items-center gap-2 rounded-full border border-white/35 bg-white/5 px-7 py-3 text-sm font-semibold text-white backdrop-blur transition
