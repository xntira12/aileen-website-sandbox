...
const slides = [
  <p
    key={0}
    className="absolute inset-0 flex items-center lg:items-start flex-col justify-center w-full max-w-[38rem] pr-2 text-center lg:text-left leading-[1.15] tracking-[-0.01em]"
  >
    <span className="text-white/50 text-xl font-normal tracking-wide">
      ยกระดับการทำงานทั้งองค์กรด้วย
    </span>
    <span className="text-white font-bold text-[50px] pt-2">
      <em className="not-italic">Digital Process</em>
    </span>
    <span className="text-white font-bold text-[50px] pt-1">
      & <em className="not-italic">Automation</em>
    </span>
  </p>,
  <p
    key={1}
    className="absolute inset-0 flex items-center lg:items-start flex-col justify-center w-full max-w-[38rem] pr-2 text-center lg:text-left leading-[1.2] tracking-[-0.01em]"
  >
    <span className="text-white/60 text-xl lg:text-xl">
      เลิกพึ่งเอกสารเปลี่ยนสู่<em className="text-white">แพลตฟอร์ม</em>ที่
    </span>
    <span className="text-white font-bold text-5xl lg:text-5xl mt-2">
      ควบคุมและ
    </span>
    <span className="text-white font-bold text-5xl lg:text-5xl mt-2">
      ตรวจสอบได้จริง
  ...
  >
    ...
    <span className="text-white font-bold text-7xl lg:text-7xl">
      <em className="not-italic">งานซ้ำ ๆ</em>
    </span>
    <span className="text-white/70 text-xl font-normal mt-1">
      จนไม่มีเวลาสร้าง
      <strong className="text-white text-2xl font-semibold">คุณค่าใหม่</strong>
      อยู่หรือไม่?
    </span>
  </p>,
  <p
  ...
  >
    <span className="text-white/60 text-xl lg:text-xl">
      AI ที่ดีเริ่มจากข้อมูลที่ดี
    </span>
    <span className="text-white text-5xl mt-1 font-bold">
      องค์กรคุณพร้อมสำหรับ AI แล้วหรือยัง ?
    </span>
  </p>,
  <p
    key={4}
  ...
  >
    ...
    <span className="text-white font-bold text-4xl lg:text-5xl pt-2">
      <em className="not-italic">มองเห็น</em>และ
      <em className="not-italic">พัฒนา</em>ได้จริง
    </span>
    <span className="text-white/50 text-xl mt-1 pt-2">
      องค์กรจะเปลี่ยนไป
      <strong className="text-white text-2xl font-bold">แค่ไหน?</strong>
    </span>
  </p>,
];
...
export default function Home() {
  ...
  return (
    <div id="home">
      ...
      {/* Navbar — mobile: ซ่อนจนกว่าจะ scroll | desktop: แสดงตลอด */}
      <div
      ...
      >
        <style>{`
          @media (min-width: 1024px) { .navbar-wrapper { transform: translateY(0) !important; } }
        `}</style>
        <Navbar />
      </div>
      ...
      <section className="relative w-full min-h-screen overflow-hidden bg-black">
        ...
        >
          {/* Overlay ดำทับเพื่อให้อ่านตัวหนังสือง่าย */}
          ...
          >
            <div className="flex flex-1 flex-col items-center justify-center w-full gap-8">
              ...
              <div className="mx-auto w-full max-w-6xl flex flex-col items-center gap-8 lg:flex-row lg:items-center lg:gap-0">
                ...
                {/* Divider */}
                <div
                  className="h-px w-4/5 bg-gradient-to-r from-transparent via-white/30 to-transparent lg:hidden"
                  style={{
                    opacity: isSplit ? 1 : 0,
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(to bottom, transparent, rgba(255,255,255,0.28) 20%, rgba(255,255,255,0.28) 80%, transparent)",
                    opacity: isSplit ? 1 : 0,
                    transform: isSplit ? "scaleY(1)" : "scaleY(0.1)",
                    transformOrigin: "center",
                    // ลด delay เส้น: 0.25s → 0.1s
                    transition:
                      "opacity 0.35s ease 0.1s, transform 0.35s ease 0.1s",
                  }}
                />

                {/* Carousel — ลด delay จาก 0.4s → 0.1s */}
                <div
                  className="flex w-full flex-col items-center lg:w-[35%] lg:items-start lg:pl-10"
                  style={{
                    opacity: isSplit ? 1 : 0,
                    transform: isSplit ? "translateX(0)" : "translateX(-36px)",
                    // delay 0.1s และ duration 0.45s (เดิม 0.5s delay 0.4s)
                    transition:
                      "opacity 0.45s ease 0.1s, transform 0.45s cubic-bezier(0.2,0,0.2,1) 0.1s",
                ...
                >
                    ...
                    <div
                      ...
                      style={{
                        animation: isAnimating
                          ? `slideOut${slideDir === "up" ? "Up" : "Down"} 0.38s ease forwards`
                          : `slideIn${slideDir === "up" ? "Up" : "Down"} 0.38s ease forwards`,
                        position: "absolute",
                        inset: 0,
                      }}
                    >
                  ...
                  {/* Prev / Next */}
                  <div
                    className="mt-3 flex items-center gap-1.5 self-center lg:self-start"
                    style={{
                  ...
                  >
                    ...
                    >
                      <svg
                        viewBox="0 0 8 12"
                        fill="none"
                        className="h-2 w-1.5 flex-shrink-0"
                      >
                        <path
              ...
              <div className="flex flex-col items-center text-center">
                <p className="mx-auto max-w-3xl text-sm leading-relaxed text-white/85 md:text-base">
                  ...
                  experienced consulting from process and quality to Automation
                  and AI — Empowering business efficiency and growth.
                </p>
      ...
      <section id="service" className="py-0 bg-slate-50">
